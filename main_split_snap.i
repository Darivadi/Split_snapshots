# 1 "main_split_snap.c"
# 1 "/home/darivadi/Documents/University/Master/Courses/Investigation_IV/Codes_semester_IV/Split_snapshots//"
# 1 "<built-in>"
# 1 "<command-line>"
...
int main(int argc, char *argv[])
{
  ...
  int ii, jj, kk;
  double xc, yc, zc;
  double xp, yp, zp, vxp, vyp, vzp, vmod;
  double Window_fn;
  double norm_factor;
